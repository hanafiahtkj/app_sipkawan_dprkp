...
class JumlahRumahBanjarmasinDatatable extends Datatable
{
    public $slug = 'JumlahRumahBanjarmasin';

    public function datasource()
    {
        return JumlahRumahBanjarmasin::with('kecamatan')->with('kelurahan')->get();
    }
        ...
        return [
            ...
            Column::add()
                ...
                ->actions(function ($data) {
                    ...
                    $buttons = Button::edit('boilerplate.jumlah-rumah-banjarmasin.edit', $data->id);

                    if ($currentUser->hasRole('admin')) {
                        $buttons .= Button::delete('boilerplate.jumlah-rumah-banjarmasin.destroy', $data->id);
                    }
