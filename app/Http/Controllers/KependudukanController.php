...
class KependudukanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->all();
        $dataInput = Kependudukan::create($input);

        return redirect()->route('boilerplate.kependudukan.edit', $dataInput)
    ...
    {
        $data = [
            'dataInput' => Kependudukan::find($id),
            'kecamatan' => Kecamatan::get(),
        ];
    ...
    {
        $dataInput = Kependudukan::findOrFail($id);
