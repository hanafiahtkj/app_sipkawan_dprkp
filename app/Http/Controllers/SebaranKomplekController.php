...
class SebaranKomplekController extends Controller
{
    ...
    {
        return view('sebaran-komplek.list');
    }
    ...
    {
        return view('sebaran-komplek.create', [
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->all();
        $dataInput = SebaranKomplek::create($input);

        return redirect()->route('boilerplate.sebaran-komplek.edit', $dataInput)
    ...
    {
        $data = [
            'dataInput' => SebaranKomplek::find($id),
            'kecamatan' => Kecamatan::get(),
        ];
        $keldes = KelDesa::find($data['dataInput']->id_kelurahan);
        $data['keldes'] = $keldes;

        return view('sebaran-komplek.edit', $data);
    }
    ...
    {
        $dataInput = SebaranKomplek::findOrFail($id);
