...
class AksesPembuanganAirLimbahExport implements FromView, WithEvents, ShouldAutoSize
{
    protected $rowCount;
    ...
    {
        $data = AksesPembuanganAirLimbah::all();
        $this->rowCount += count($data);
        return view('akses-pembuangan-air-limbah.excel', [
            'data' => $data
        ]);
    }
