...
class JumlahRumahBanjarmasinExport implements FromView, WithEvents, ShouldAutoSize
{
    protected $rowCount;
    ...
    {
        $data = JumlahRumahBanjarmasin::all();
        $this->rowCount += count($data);
        return view('jumlah-rumah-banjarmasin.excel', [
            'data' => $data
        ]);
    }
