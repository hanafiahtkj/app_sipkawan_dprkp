...
class JumlahPerumahanBanjarmasinExport implements FromView, WithEvents, ShouldAutoSize
{
    protected $rowCount;
    ...
    {
        $data = JumlahPerumahanBanjarmasin::all();
        $this->rowCount += count($data);
        return view('jumlah-perumahan-banjarmasin.excel', [
            'data' => $data
        ]);
    }
