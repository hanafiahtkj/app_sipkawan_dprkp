@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [
        __('Jumlah Rumah Yang Memiliki Akses Air Bersih (PDAM)') => 'boilerplate.akses-air-bersih.index',
        __('Edit Data')
    ]
])

@section('content')
    {{ Form::open(['route' => ['boilerplate.akses-air-bersih.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-12 pb-3">
                <a href="{{ route("boilerplate.akses-air-bersih.index") }}" class="btn btn-default" data-toggle="tooltip" title="@lang('boilerplate::users.returntolist')">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Jumlah Rumah Yang Memiliki Akses Air Bersih (PDAM)'])
