@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [
        __('Data Jumlah Perumahan Di Kota Banjarmasin') => 'boilerplate.jumlah-perumahan-banjarmasin.index',
        __('Edit Data')
    ]
])

@section('content')
    {{ Form::open(['route' => ['boilerplate.jumlah-perumahan-banjarmasin.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-12 pb-3">
                <a href="{{ route("boilerplate.jumlah-perumahan-banjarmasin.index") }}" class="btn btn-default" data-toggle="tooltip" title="@lang('boilerplate::users.returntolist')">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Jumlah Perumahan Di Kota Banjarmasin'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah_umum', 'label' => 'Jumlah Rumah Umum', 'value' => $dataInput->jumlah_rumah_umum])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah_komersil', 'label' => 'Jumlah Rumah Komersil', 'value' => $dataInput->jumlah_rumah_komersil])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah_swadaya', 'label' => 'Jumlah Rumah Swadaya', 'value' => $dataInput->jumlah_rumah_swadaya])@endcomponent
