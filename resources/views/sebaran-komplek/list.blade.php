...
@section('content')
    ...
    <!-- Modal -->
    <form id="formWrapperModal" method="POST" action="{{ route("boilerplate.sebaran-komplek.import") }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="{{ asset('assets/excel/sebaran_komplek.xlsx') }}" target="_blank">Download Format Import.xls</a>
                    </div>
