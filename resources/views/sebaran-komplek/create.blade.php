...
@section('content')
    {{ Form::open(['route' => 'boilerplate.sebaran-komplek.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Sebaran Komplek Perumanan'])
                    @component('boilerplate::input', ['name' => 'nama_perumahan', 'label' => 'boilerplate::sebarankomplek.nama_perumahan', 'autofocus' => true])@endcomponent
                    @component('boilerplate::input', ['name' => 'nama_pengembang', 'label' => 'boilerplate::sebarankomplek.nama_pengembang'])@endcomponent
