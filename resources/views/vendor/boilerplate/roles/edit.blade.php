...
@section('content')
    {{ Form::open(['route' => ['boilerplate.roles.update', $role->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        ...
        <div class="row">
            <div class="col-md-5">
                @component('boilerplate::card', ['color' => 'light', 'title' => __('boilerplate::role.parameters')])
            ...
            <div class="col-md-7">
                @component('boilerplate::card', ['color' => 'light', 'title' => __('boilerplate::role.permissions')])
