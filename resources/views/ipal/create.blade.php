...
@section('content')
    {{ Form::open(['route' => 'boilerplate.ipal.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Jumlah IPAL'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_ipal', 'label' => 'Jumlah IPAL'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'kapasitas_ipal', 'label' => 'Kapasitas IPAL'])@endcomponent
