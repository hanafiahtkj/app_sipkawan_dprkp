@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [
        __('Data Jumlah Rumah Di Kota Banjarmasin') => 'boilerplate.jumlah-rumah-banjarmasin.index',
        __('Edit Data')
    ]
])

@section('content')
    {{ Form::open(['route' => ['boilerplate.jumlah-rumah-banjarmasin.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
            <div class="col-12 pb-3">
                <a href="{{ route("boilerplate.jumlah-rumah-banjarmasin.index") }}" class="btn btn-default" data-toggle="tooltip" title="@lang('boilerplate::users.returntolist')">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Jumlah Rumah Di Kota Banjarmasin'])
