...
@section('content')
    {{ Form::open(['route' => ['boilerplate.proyek-perumahan.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Jumlah Rumah Yang Dibangun/ Di Berikan Peningkatan Kualitas / Di Renovasi'])
                    ...
                    @component('boilerplate::input', ['name' => 'jenis_penanganan', 'label' => 'Jenis Penanganan', 'value' => $dataInput->jenis_penanganan])@endcomponent
                    @component('boilerplate::input', ['name' => 'jenis_program', 'label' => 'Jenis Program', 'value' => $dataInput->jenis_program])@endcomponent
