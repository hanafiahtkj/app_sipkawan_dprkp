...
@section('content')
    {{ Form::open(['route' => ['boilerplate.rawan-bencana.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
            ...
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Perumahan di Lokasi Rawan Bencana'])
                    ...
                    @component('boilerplate::select2', ['name' => 'tingkat_kerawanan', 'label' => 'boilerplate::rawanbencana.tingkat_kerawanan', 'minimum-results-for-search' => '-1'])
                        ...
                        <option value="2" @if (old('tingkat_kerawanan', $dataInput->tingkat_kerawanan) == '2') selected="selected" @endif>Sedang</option>
                        <option value="2" @if (old('tingkat_kerawanan', $dataInput->tingkat_kerawanan) == '3') selected="selected" @endif>Tinggi</option>
                    @endcomponent
                    ...
                    @component('boilerplate::input', ['name' => 'rw', 'label' => 'boilerplate::rawanbencana.rw', 'value' => $dataInput->rw])@endcomponent
                    @component('boilerplate::input', ['name' => 'rt', 'label' => 'boilerplate::rawanbencana.rt', 'value' => $dataInput->rt])@endcomponent
                    @component('boilerplate::input', ['name' => 'luas', 'label' => 'boilerplate::rawanbencana.luas', 'value' => $dataInput->luas])@endcomponent
