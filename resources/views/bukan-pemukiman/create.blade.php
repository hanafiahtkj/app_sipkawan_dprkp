...
@section('content')
    {{ Form::open(['route' => 'boilerplate.bukan-pemukiman.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @component('boilerplate::select2', ['name' => 'id_kecamatan', 'label' => 'boilerplate::korbanbencana.kecamatan', 'id' => 'id_kecamatan', 'minimum-results-for-search' => '-1'])
                    ...
                    @component('boilerplate::input', ['name' => 'luas', 'label' => 'boilerplate::bukanpemukiman.luas'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah', 'label' => 'boilerplate::bukanpemukiman.jumlah_rumah'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_kk', 'label' => 'boilerplate::bukanpemukiman.jumlah_kk'])@endcomponent
