...
@section('content')
    {{ Form::open(['route' => 'boilerplate.jumlah-penerbitan-sertifikat.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Jumlah Penerbitan Sertifikat'])
                    ...
                    @component('boilerplate::input', ['name' => 'shgb', 'label' => 'SHGB'])@endcomponent
                    @component('boilerplate::input', ['name' => 'shm', 'label' => 'SHM'])@endcomponent
