...
@section('content')
    {{ Form::open(['route' => ['boilerplate.pengajuan-psu.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
            ...
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Status Pengajuan PSU Perumahan'])
                    ...
                    @component('boilerplate::select2', ['name' => 'jenis', 'label' => 'boilerplate::pengajuanpsu.jenis', 'minimum-results-for-search' => '-1'])
                        ...
                        <option value="2" @if (old('jenis', $dataInput->jenis) == '2') selected="selected" @endif>Jalan</option>
                    @endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'luas', 'label' => 'boilerplate::pengajuanpsu.luas', 'value' => $dataInput->luas])@endcomponent
                    @component('boilerplate::components.datetimepicker', ['name' => 'tanggal', 'label' => 'boilerplate::pengajuanpsu.tanggal', 'value' => $dataInput->tanggal, 'appendText' => 'far fa-calendar-alt', 'format' => 'YYYY-MM-DD', 'value' => now()])@endcomponent()
                    @component('boilerplate::input', ['name' => 'status', 'label' => 'boilerplate::pengajuanpsu.status', 'value' => $dataInput->status])@endcomponent
                @endcomponent
            </div>
        </div>
    {{ Form::close() }}
