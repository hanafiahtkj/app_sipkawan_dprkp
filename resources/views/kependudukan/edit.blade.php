...
@section('content')
    {{ Form::open(['route' => ['boilerplate.kependudukan.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Kependudukan'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_penduduk', 'label' => 'Jumlah Penduduk', 'value' => $dataInput->jumlah_penduduk])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_kk', 'label' => 'Jumlah KK', 'value' => $dataInput->jumlah_kk])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rt', 'label' => 'Jumlah RT', 'value' => $dataInput->jumlah_rt])@endcomponent
