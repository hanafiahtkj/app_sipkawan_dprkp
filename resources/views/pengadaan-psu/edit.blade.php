...
@section('content')
    {{ Form::open(['route' => ['boilerplate.pengadaan-psu.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Status Pengadaan PSU Perumahan'])
                    ...
                    @component('boilerplate::input', ['name' => 'nama_perumahan', 'label' => 'boilerplate::pengadaanpsu.nama_perumahan', 'value' => $dataInput->nama_perumahan, 'autofocus' => true])@endcomponent
                    ...
                    @endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'luas', 'label' => 'boilerplate::pengadaanpsu.luas', 'value' => $dataInput->luas])@endcomponent
                    @component('boilerplate::input', ['name' => 'status', 'label' => 'boilerplate::pengadaanpsu.status', 'value' => $dataInput->status])@endcomponent
                @endcomponent
            </div>
        </div>
    {{ Form::close() }}
