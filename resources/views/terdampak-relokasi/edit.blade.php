...
@section('content')
    {{ Form::open(['route' => ['boilerplate.terdampak-relokasi.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Rumah yang Terkena Relokasi'])
                    ...
                    @component('boilerplate::input', ['name' => 'jenis', 'label' => 'boilerplate::terdampakrelokasi.jenis', 'value' => $dataInput->jenis, 'autofocus' => true])@endcomponent
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah', 'label' => 'boilerplate::terdampakrelokasi.jumlah_rumah', 'value' => $dataInput->jumlah_rumah])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_kk', 'label' => 'boilerplate::terdampakrelokasi.jumlah_kk', 'value' => $dataInput->jumlah_kk])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_jiwa', 'label' => 'boilerplate::terdampakrelokasi.jumlah_jiwa', 'value' => $dataInput->jumlah_jiwa])@endcomponent
