...
@section('content')
    {{ Form::open(['route' => ['boilerplate.rumah-susun.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Sebaran Rumah Susun Kota Banjarmasin'])
                    ...
                    @component('boilerplate::input', ['name' => 'nama_rumah_susun', 'label' => 'boilerplate::rumahsusun.nama_rumah_susun', 'value' => $dataInput->nama_rumah_susun, 'autofocus' => true])@endcomponent
                    ...
                    @component('boilerplate::input', ['name' => 'alamat', 'label' => 'boilerplate::rumahsusun.alamat', 'value' => $dataInput->alamat])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'luas', 'label' => 'boilerplate::rumahsusun.luas', 'value' => $dataInput->luas])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah', 'label' => 'boilerplate::rumahsusun.jumlah', 'value' => $dataInput->jumlah])@endcomponent
                @endcomponent
            </div>
        </div>
    {{ Form::close() }}
