@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [
        __('PJumlah Rumah di Kawasan Kumuh') => 'boilerplate.kawasan-kumuh.index',
        __('Tambah Data')
    ]
])

@section('content')
    {{ Form::open(['route' => 'boilerplate.kawasan-kumuh.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Jumlah Rumah di Kawasan Kumuh'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah', 'label' => 'boilerplate::kawasankumuh.jumlah_rumah'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_kk', 'label' => 'boilerplate::kawasankumuh.jumlah_kk'])@endcomponent
                @endcomponent
            </div>
        </div>
    {{ Form::close() }}
