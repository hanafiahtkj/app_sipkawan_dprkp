@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [__('Bantuan PSU Perumanan')],
])
...
@section('content')
    <div class="row">
        <div class="col-sm-12 mb-3">
            <span class="float-right">
                ...
                <a href="{{ route("boilerplate.sebaran-komplek.export") }}" class="btn btn-default mr-1">
                    <i class="fas fa-file-export text-success"></i> Export Excel
                </a> --}}
                <a href="{{ route('boilerplate.bantuan-psu.create') }}" class="btn btn-primary">
    ...
    @component('boilerplate::card')
        @component('boilerplate::datatable', ['name' => 'bantuanPsu'])
        @endcomponent
    @endcomponent

    <!-- Modal -->
    <form id="formWrapperModal" method="POST" action="{{ route('boilerplate.sebaran-komplek.import') }}"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="{{ asset('assets/excel/sebaran_komplek.xlsx') }}" target="_blank">Download Format
                            Import.xls</a>
                    </div>
