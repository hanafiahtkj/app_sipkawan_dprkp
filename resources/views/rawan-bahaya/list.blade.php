...
@section('content')
    <div class="row">
        <div class="col-sm-12 mb-3">
            <span class="float-right">
                ...
                <a href="{{ route("boilerplate.rawan-bahaya.export") }}" class="btn btn-default mr-1">
    ...
    @endcomponent
     ...
     <!-- Modal -->
     <form id="formWrapperModal" method="POST" action="{{ route("boilerplate.rawan-bahaya.import") }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="{{ asset('assets/excel/rawan_bahaya.xlsx') }}" target="_blank">Download Format Import.xls</a>
                    </div>
