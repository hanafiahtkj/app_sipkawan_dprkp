...
@section('content')
    {{ Form::open(['route' => 'boilerplate.rawan-bahaya.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Perumahan di Lokasi Rawan Bahaya'])
                    @component('boilerplate::input', ['name' => 'jenis', 'label' => 'boilerplate::rawanbahaya.jenis', 'autofocus' => true])@endcomponent
                    ...
                    @component('boilerplate::input', ['name' => 'luas', 'label' => 'boilerplate::rawanbahaya.luas'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_rumah', 'label' => 'boilerplate::rawanbahaya.jumlah_rumah'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_kk', 'label' => 'boilerplate::rawanbahaya.jumlah_kk'])@endcomponent
