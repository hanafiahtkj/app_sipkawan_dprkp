@extends('boilerplate::layout.index', [
    ...
    'breadcrumb' => [
        __('Perumahan di Lahan Bukan Pemukiman') => 'boilerplate.bantaran-sungai.index',
        __('Edit Data')
    ]
])

@section('content')
    {{ Form::open(['route' => ['boilerplate.bantaran-sungai.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Perumahan di Lahan Bukan Pemukiman'])
                    ...
                    @component('boilerplate::input', ['name' => 'jenis_penanganan', 'label' => 'boilerplate::bantaransungai.jenis_penanganan', 'value' => $dataInput->jenis_penanganan])@endcomponent
                    @component('boilerplate::select2', ['name' => 'jenis', 'label' => 'boilerplate::bantaransungai.jenis', 'minimum-results-for-search' => '-1'])
                        <option value="1" @if (old('jenis', $dataInput->jenis) == '1') selected="selected" @endif>Luas</option>
                        <option value="2" @if (old('jenis', $dataInput->jenis) == '2') selected="selected" @endif>Panjang</option>
                    @endcomponent
                @endcomponent
            </div>
        </div>
