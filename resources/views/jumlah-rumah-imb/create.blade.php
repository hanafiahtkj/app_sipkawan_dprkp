...
@section('content')
    {{ Form::open(['route' => 'boilerplate.jumlah-rumah-imb.store', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Data Jumlah Rumah Rumah Yang Memiliki IMB/PBG'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'perorangan', 'label' => 'Perorangan (UNIT)'])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'pengembang', 'label' => 'Pengembang Perumahan (UNIT)'])@endcomponent
