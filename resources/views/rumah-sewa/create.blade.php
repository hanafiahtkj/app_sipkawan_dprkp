...
@section('content')
    {{ Form::open(['route' => 'boilerplate.rumah-sewa.store', 'autocomplete' => 'off', 'files' => true]) }}
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
            @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Rumah Sewa Milik Masyarakat'])
                @component('boilerplate::input', ['type' => 'number', 'name' => 'tahun', 'label' => 'Tahun'])
                @endcomponent
                ...
                @endcomponent
                @component('boilerplate::input', ['name' => 'alamat', 'label' => 'boilerplate::rumahsewa.alamat'])
                @endcomponent
                ...
                @endcomponent
                @component('boilerplate::input', ['name' => 'keterangan', 'label' => 'boilerplate::rumahsewa.keterangan'])
                @endcomponent
