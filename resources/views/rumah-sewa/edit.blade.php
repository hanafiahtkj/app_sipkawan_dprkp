...
@section('content')
    {{ Form::open(['route' => ['boilerplate.rumah-sewa.update', $dataInput->id], 'method' => 'put', 'autocomplete' => 'off']) }}
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                @component('boilerplate::card', ['color' => 'light', 'title' => 'Data Rumah Sewa Milik Masyarakat'])
                    ...
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'luas_hunian', 'label' => 'boilerplate::rumahsewa.luas_hunian', 'value' => $dataInput->luas_hunian])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'jumlah_hunian', 'label' => 'boilerplate::rumahsewa.jumlah_hunian', 'value' => $dataInput->jumlah_hunian])@endcomponent
                    @component('boilerplate::input', ['type' => 'number', 'name' => 'tarif_sewa', 'label' => 'boilerplate::rumahsewa.tarif_sewa', 'value' => $dataInput->tarif_sewa])@endcomponent
                    ...
                    @endcomponent
                    @component('boilerplate::input', ['name' => 'keterangan', 'label' => 'boilerplate::rumahsewa.keterangan', 'value' => $dataInput->keterangan])@endcomponent
                @endcomponent
            </div>
        </div>
    {{ Form::close() }}
